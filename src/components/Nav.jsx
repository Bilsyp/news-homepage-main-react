...
const Nav = () => {
  ...
  return (
    <>
      <nav className='md:px-9 px-3 py-4 top-0 sticky md:static backdrop-blur   '>
        <div className='nav_container flex justify-between items-center  gap-10'>
          ...
          <div
            className={`${
              !toogle ? "show" : ""
            } container_item  absolute  bg-shadows top-0  left-0 w-full h-screen  flex  justify-end   sm:w-full sm:h-auto  sm:overflow-auto  sm:static sm:bg-transparent`}
